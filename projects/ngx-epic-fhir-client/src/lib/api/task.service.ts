...
export class TaskService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public taskSearchCommunityResourceR4(
    code?: string,
    encounter?: string,
    patient?: string,
    subject?: string,
  ...
  public taskSearchCommunityResourceR4(
    ...
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<BundleTaskR4>>;
  public taskSearchCommunityResourceR4(
    code?: string,
    encounter?: string,
    patient?: string,
    ...
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<BundleTaskR4>>;
  public taskSearchCommunityResourceR4(
    code?: string,
    encounter?: string,
    patient?: string,
    ...
    return this.httpClient.request<BundleTaskR4>(
      'get',
      `${this.basePath}/R4/Task`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public taskUpdateCommunityResourceR4(
    body: TaskR4,
    ID: string,
    observe?: 'body',
    reportProgress?: boolean
  ...
  public taskUpdateCommunityResourceR4(
    ...
    if (body === null || body === undefined) {
      throw new Error(
        'Required parameter body was null or undefined when calling taskUpdateCommunityResourceR4.'
      );
    }

    if (ID === null || ID === undefined) {
      throw new Error(
        'Required parameter ID was null or undefined when calling taskUpdateCommunityResourceR4.'
      );
    }
