...
export class BodyStructureService {
   ...
   */
  public bodyStructureReadToothR4(
    ID: string,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<BodyStructureR4>;
  public bodyStructureReadToothR4(
    ID: string,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<BodyStructureR4>>;
  public bodyStructureReadToothR4(
    ID: string,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<BodyStructureR4>>;
  public bodyStructureReadToothR4(
    ID: string,
    observe: any = 'body',
    ...
    if (ID === null || ID === undefined) {
      throw new Error(
        'Required parameter ID was null or undefined when calling bodyStructureReadToothR4.'
      );
    }
    ...
    return this.httpClient.request<BodyStructureR4>(
      'get',
      `${this.basePath}/R4/BodyStructure/${encodeURIComponent(String(ID))}`,
      {
