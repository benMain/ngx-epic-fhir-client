...
export class SearchSTU3Service {
     ...
     */
    public allergyIntoleranceSearchSTU3(patient: string, observe?: 'body', reportProgress?: boolean): Observable<BundleAllergyIntoleranceSTU3>;
    public allergyIntoleranceSearchSTU3(patient: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BundleAllergyIntoleranceSTU3>>;
    public allergyIntoleranceSearchSTU3(patient: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BundleAllergyIntoleranceSTU3>>;
    public allergyIntoleranceSearchSTU3(patient: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (patient === null || patient === undefined) {
            throw new Error('Required parameter patient was null or undefined when calling allergyIntoleranceSearchSTU3.');
        }
        ...
        return this.httpClient.request<BundleAllergyIntoleranceSTU3>('get',`${this.basePath}/STU3/AllergyIntolerance`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public appointmentSearchSTU3(patient: string, date?: string, identifier?: string, status?: string, observe?: 'body', reportProgress?: boolean): Observable<BundleAppointmentSTU3>;
    public appointmentSearchSTU3(patient: string, date?: string, identifier?: string, status?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BundleAppointmentSTU3>>;
    public appointmentSearchSTU3(patient: string, date?: string, identifier?: string, status?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BundleAppointmentSTU3>>;
    public appointmentSearchSTU3(patient: string, date?: string, identifier?: string, status?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (patient === null || patient === undefined) {
            throw new Error('Required parameter patient was null or undefined when calling appointmentSearchSTU3.');
        }
        ...
        return this.httpClient.request<BundleAppointmentSTU3>('get',`${this.basePath}/STU3/Appointment`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deviceRequestSearchSTU3(patient: string, status?: string, observe?: 'body', reportProgress?: boolean): Observable<BundleDeviceRequestSTU3>;
    public deviceRequestSearchSTU3(patient: string, status?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BundleDeviceRequestSTU3>>;
    public deviceRequestSearchSTU3(patient: string, status?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BundleDeviceRequestSTU3>>;
    public deviceRequestSearchSTU3(patient: string, status?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (patient === null || patient === undefined) {
            throw new Error('Required parameter patient was null or undefined when calling deviceRequestSearchSTU3.');
        }
        ...
        return this.httpClient.request<BundleDeviceRequestSTU3>('get',`${this.basePath}/STU3/DeviceRequest`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public medicationStatementSearchSTU3(patient: string, subject: string, category?: string, effective?: string, status?: string, observe?: 'body', reportProgress?: boolean): Observable<BundleMedicationStatementSTU3>;
    public medicationStatementSearchSTU3(patient: string, subject: string, category?: string, effective?: string, status?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BundleMedicationStatementSTU3>>;
    public medicationStatementSearchSTU3(patient: string, subject: string, category?: string, effective?: string, status?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BundleMedicationStatementSTU3>>;
    public medicationStatementSearchSTU3(patient: string, subject: string, category?: string, effective?: string, status?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (patient === null || patient === undefined) {
            throw new Error('Required parameter patient was null or undefined when calling medicationStatementSearchSTU3.');
        }

        if (subject === null || subject === undefined) {
            throw new Error('Required parameter subject was null or undefined when calling medicationStatementSearchSTU3.');
        }
        ...
        return this.httpClient.request<BundleMedicationStatementSTU3>('get',`${this.basePath}/STU3/MedicationStatement`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
