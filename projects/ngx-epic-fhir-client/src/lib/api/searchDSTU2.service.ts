...
export class SearchDSTU2Service {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public familyMemberHistorySearchDSTU2(patient?: string, subject?: string, observe?: 'body', reportProgress?: boolean): Observable<BundleFamilyMemberHistoryDSTU2>;
    public familyMemberHistorySearchDSTU2(patient?: string, subject?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BundleFamilyMemberHistoryDSTU2>>;
    public familyMemberHistorySearchDSTU2(patient?: string, subject?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BundleFamilyMemberHistoryDSTU2>>;
    public familyMemberHistorySearchDSTU2(patient?: string, subject?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<BundleFamilyMemberHistoryDSTU2>('get',`${this.basePath}/DSTU2/FamilyMemberHistory`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
