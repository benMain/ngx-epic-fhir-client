...
export class DocumentReferenceService {
     ...
     */
    public documentReferenceCreateClinicalNotesSTU3(body: DocumentReferenceSTU3, observe?: 'body', reportProgress?: boolean): Observable<DocumentReferenceSTU3>;
    public documentReferenceCreateClinicalNotesSTU3(body: DocumentReferenceSTU3, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DocumentReferenceSTU3>>;
    public documentReferenceCreateClinicalNotesSTU3(body: DocumentReferenceSTU3, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DocumentReferenceSTU3>>;
    public documentReferenceCreateClinicalNotesSTU3(body: DocumentReferenceSTU3, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling documentReferenceCreateClinicalNotesSTU3.');
        }
        ...
        return this.httpClient.request<DocumentReferenceSTU3>('post',`${this.basePath}/STU3/DocumentReference`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public documentReferenceReadGeneratedCCDADSTU2(ID: string, observe?: 'body', reportProgress?: boolean): Observable<DocumentReferenceDSTU2>;
    public documentReferenceReadGeneratedCCDADSTU2(ID: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DocumentReferenceDSTU2>>;
    public documentReferenceReadGeneratedCCDADSTU2(ID: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DocumentReferenceDSTU2>>;
    public documentReferenceReadGeneratedCCDADSTU2(ID: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ID === null || ID === undefined) {
            throw new Error('Required parameter ID was null or undefined when calling documentReferenceReadGeneratedCCDADSTU2.');
        }
        ...
        return this.httpClient.request<DocumentReferenceDSTU2>('get',`${this.basePath}/DSTU2/DocumentReference/${encodeURIComponent(String(ID))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public documentReferenceReadRadiologyResultsR4(ID: string, observe?: 'body', reportProgress?: boolean): Observable<DocumentReferenceR4>;
    public documentReferenceReadRadiologyResultsR4(ID: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DocumentReferenceR4>>;
    public documentReferenceReadRadiologyResultsR4(ID: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DocumentReferenceR4>>;
    public documentReferenceReadRadiologyResultsR4(ID: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ID === null || ID === undefined) {
            throw new Error('Required parameter ID was null or undefined when calling documentReferenceReadRadiologyResultsR4.');
        }
        ...
        return this.httpClient.request<DocumentReferenceR4>('get',`${this.basePath}/R4/DocumentReference/${encodeURIComponent(String(ID))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public documentReferenceReadRadiologyResultsSTU3(ID: string, observe?: 'body', reportProgress?: boolean): Observable<DocumentReferenceSTU3>;
    public documentReferenceReadRadiologyResultsSTU3(ID: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DocumentReferenceSTU3>>;
    public documentReferenceReadRadiologyResultsSTU3(ID: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DocumentReferenceSTU3>>;
    public documentReferenceReadRadiologyResultsSTU3(ID: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ID === null || ID === undefined) {
            throw new Error('Required parameter ID was null or undefined when calling documentReferenceReadRadiologyResultsSTU3.');
        }
        ...
        return this.httpClient.request<DocumentReferenceSTU3>('get',`${this.basePath}/STU3/DocumentReference/${encodeURIComponent(String(ID))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public documentReferenceSearchRadiologyResultsR4(author?: string, category?: string, date?: string, patient?: string, period?: string, subject?: string, type?: string, observe?: 'body', reportProgress?: boolean): Observable<BundleDocumentReferenceR4>;
    public documentReferenceSearchRadiologyResultsR4(author?: string, category?: string, date?: string, patient?: string, period?: string, subject?: string, type?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BundleDocumentReferenceR4>>;
    public documentReferenceSearchRadiologyResultsR4(author?: string, category?: string, date?: string, patient?: string, period?: string, subject?: string, type?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BundleDocumentReferenceR4>>;
    public documentReferenceSearchRadiologyResultsR4(author?: string, category?: string, date?: string, patient?: string, period?: string, subject?: string, type?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<BundleDocumentReferenceR4>('get',`${this.basePath}/R4/DocumentReference`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
