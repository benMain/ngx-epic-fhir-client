...
import { BundleConsentR4 } from '../model/bundleConsentR4';
import { BundleConsentSTU3 } from '../model/bundleConsentSTU3';
import { ConsentR4 } from '../model/consentR4';
import { ConsentSTU3 } from '../model/consentSTU3';
...
export class ConsentService {
     ...
     * 
     * 
     * @param ID The FHIR ID for a Consent resource.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public consentReadDocumentR4(ID: string, observe?: 'body', reportProgress?: boolean): Observable<ConsentR4>;
    public consentReadDocumentR4(ID: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ConsentR4>>;
    public consentReadDocumentR4(ID: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ConsentR4>>;
    public consentReadDocumentR4(ID: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ID === null || ID === undefined) {
            throw new Error('Required parameter ID was null or undefined when calling consentReadDocumentR4.');
        }
        ...
        return this.httpClient.request<ConsentR4>('get',`${this.basePath}/R4/Consent/${encodeURIComponent(String(ID))}`,
            {
     ...
     * 
     * 
     * @param ID The Consent FHIR ID.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public consentReadDocumentSTU3(ID: string, observe?: 'body', reportProgress?: boolean): Observable<ConsentSTU3>;
    public consentReadDocumentSTU3(ID: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ConsentSTU3>>;
    public consentReadDocumentSTU3(ID: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ConsentSTU3>>;
    public consentReadDocumentSTU3(ID: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ID === null || ID === undefined) {
            throw new Error('Required parameter ID was null or undefined when calling consentReadDocumentSTU3.');
        }
        ...
        return this.httpClient.request<ConsentSTU3>('get',`${this.basePath}/STU3/Consent/${encodeURIComponent(String(ID))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * 
     * 
     * @param category The type of code status. Code statuses always include the Advanced Directive (acd) category from the specification of the FHIR ConsentCategoryCodes (consent-category) value set, and additional information about what type of code status.
     * @param patient FHIR ID for the Patient the consent applies to.
     * @param status The state of the code status for a patient. This value follows the specification of the FHIR ConsentState value set. 
     * @param subject FHIR ID for the Patient the consent applies to.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public consentSearchCodeStatusR4(category?: string, patient?: string, status?: string, subject?: string, observe?: 'body', reportProgress?: boolean): Observable<BundleConsentR4>;
    public consentSearchCodeStatusR4(category?: string, patient?: string, status?: string, subject?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BundleConsentR4>>;
    public consentSearchCodeStatusR4(category?: string, patient?: string, status?: string, subject?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BundleConsentR4>>;
    public consentSearchCodeStatusR4(category?: string, patient?: string, status?: string, subject?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<BundleConsentR4>('get',`${this.basePath}/R4/Consent`,
            {
