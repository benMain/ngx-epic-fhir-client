...
export class ValueSetService {
     ...
     */
    public valueSetexpandR4(context: string, contextdirection: string, filter?: string, observe?: 'body', reportProgress?: boolean): Observable<ValueSetR4>;
    public valueSetexpandR4(context: string, contextdirection: string, filter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ValueSetR4>>;
    public valueSetexpandR4(context: string, contextdirection: string, filter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ValueSetR4>>;
    public valueSetexpandR4(context: string, contextdirection: string, filter?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (context === null || context === undefined) {
            throw new Error('Required parameter context was null or undefined when calling valueSetexpandR4.');
        }

        if (contextdirection === null || contextdirection === undefined) {
            throw new Error('Required parameter contextdirection was null or undefined when calling valueSetexpandR4.');
        }
        ...
        if (contextdirection !== undefined && contextdirection !== null) {
            queryParameters = queryParameters.set('contextdirection', <any>contextdirection);
        }
        ...
        return this.httpClient.request<ValueSetR4>('get',`${this.basePath}/R4/ValueSet/$expand`,
            {
